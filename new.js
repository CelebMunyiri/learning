...
// Assuming your file is named "example.txt" in the same folder
...
const ProjectOnHold = mongoose.model('ProjectOnHold', dataSchema)



const XLSX = require('xlsx');
const workbook = XLSX.readFile(filePath);
const sheetName = 'Terminated'; // Name of the sheet you want to read
const sheet = workbook.Sheets[sheetName];
const data = XLSX.utils.sheet_to_json(sheet);

data.forEach(async (item) => {
    try {
        await ProjectOnHold.create(item);
        console.log('Data uploaded:', item);
    } catch (error) {
